...
\begin{itemize}
    ...
    \item \texttt{/add <domain>} --- Add a domain to the shared or current instance watchlist.
    \item \texttt{/remove <domain>} --- Remove a domain from the shared current instance watchlist.
